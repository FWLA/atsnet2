 ...
 */
class Organisation extends \Atemschutz\CoreBundle\Entity\Organisation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'address1', 'address2', 'plz', 'ort', 'telefon', 'users');
    }
